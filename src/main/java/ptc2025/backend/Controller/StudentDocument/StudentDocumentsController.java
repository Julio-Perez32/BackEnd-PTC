...
public class StudentDocumentsController {
    ...
    @GetMapping("/getStudentDocumentsPagination")
    public ResponseEntity<Page<StudentDocumentsDTO>> getStudentDocumentPagination(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size) {

        Page<StudentDocumentsDTO> levels = service.getStudentDocumentPagination(page, size);
