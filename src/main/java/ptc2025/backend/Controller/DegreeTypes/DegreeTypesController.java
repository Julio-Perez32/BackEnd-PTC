...
import ptc2025.backend.Services.DegreeTypes.DegreeTypesService;
...
@RestController
@RequestMapping("/api/DegreeTypes")
public class DegreeTypesController {
    @Autowired
    private DegreeTypesService service;
    ...
    @PutMapping("/UpdateDegreeType/{id}")
    ...
    @DeleteMapping("/DeleteDegreeType/{id}")
