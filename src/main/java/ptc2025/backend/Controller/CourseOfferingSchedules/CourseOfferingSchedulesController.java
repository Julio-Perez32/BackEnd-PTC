...
public class CourseOfferingSchedulesController {
    ...
    @GetMapping("/getAllCourseOfferingSchedulesPagination")
    public ResponseEntity<Page<CourseOfferingSchedulesDTO>> getAllCourseOfferingSchedulesPagination(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size) {

        Page<CourseOfferingSchedulesDTO> levels = service.getAllCourseOfferingSchedulesPagination(page, size);
