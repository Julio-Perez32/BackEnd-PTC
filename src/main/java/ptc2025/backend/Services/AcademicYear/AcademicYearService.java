...
public class AcademicYearService {
    ...
    public AcademicYearDTO insertAcademicYear(AcademicYearDTO dto) {
        if (dto == null) {
            throw new ExceptionValidationError("Los campos deben de ir completos");
        }
        try {
            ...
            throw new ExceptionServerError("No se pudo crear el año académico: " + e.getMessage());
        }
    }
    ...
    public AcademicYearDTO updateAcademicYear(String id, AcademicYearDTO dto) {
        try {
                ...
                if (dto.getUniversityId() != null) {
                    UniversityEntity university = repoUniversity.findById(dto.getUniversityId())
                            .orElseThrow(() -> new ExceptionNotFound(
                                    "Universidad no encontrada con ID: " + dto.getUniversityId()
                            ));
            ...
            throw new ExceptionNotFound("El año académico con el id " + id + " no existe");
        } catch (ExceptionNotFound e) {
            throw e;
        } catch (Exception e) {
            throw new ExceptionServerError("No se pudo actualizar el año académico: " + e.getMessage());
        }
    }
